...
Результаты разных этапов турнира связаны между собой.

Изменение результатов группового этапа может повлиять на состав участников плей-офф и дальнейшую сетку, поэтому данные приложения управляются как единое связанное состояние.

Для этого используется **Zustand**.

### ♻️ Миграции сохранений

Прогноз сохраняется локально.

При изменении структуры данных старые сохранения должны корректно адаптироваться к новой версии приложения, поэтому предусмотрена логика миграций.

### 🧪 Автоматические тесты

Ключевая турнирная логика покрыта тестами:

- расчёт групповых таблиц;
...
На текущей версии проходят **26 автоматических тестов**.

## 📤 Экспорт и сохранение

Проект позволяет сохранять и передавать пользовательский прогноз.

Поддерживаются:

- 💾 локальное сохранение;
- 🔗 share-code;
- 📋 итоговое представление прогноза;
- 🏅 выбранные индивидуальные награды;
- 📤 экспорт результата.

---

<p align="center">
  <a href="https://courageous-elf-34b597.netlify.app"><img src="https://img.shields.io/badge/▶_ОТКРЫТЬ_ПРОЕКТ-8B5CF6?style=for-the-badge" alt="Открыть проект" height="30" /></a>
  <a href="https://github.com/mrjakeball/portfolio"><img src="https://img.shields.io/badge/←_КАТАЛОГ_ПРОЕКТОВ-21262D?style=for-the-badge" alt="Каталог проектов" height="30" /></a>
</p>
